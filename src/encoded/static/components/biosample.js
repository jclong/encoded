                ...
                <div className="panel data-display">
                    ...
                    {context.derived_from ?
                        <div>
                            ...
                            <section className="panel-body" data-test="derivedfrom">
                    ...
                    {context.part_of ?
                        <div>
                            ...
                            <section className="panel-body" data-test="separatedfrom">
                    ...
                    {context.pooled_from.length ?
                        <div>
                            ...
                            <section className="panel-body" data-test="pooledfrom">
    ...
    render: function() {
        ...
        if (biosample && biosample.model_organism_donor_constructs) {
            biosample.model_organism_donor_constructs.forEach(function (construct) {
                donor_constructs[construct['@id']] = Panel({context: construct});
            ...
            <section className="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                <div className={globals.itemClass(context, panelClass)}>
                    <div className="panel-heading sentence-case">
                        <h4>{characterization ? context.characterization_method : context.document_type}</h4>
                    </div>
                    <div className="panel-body">
